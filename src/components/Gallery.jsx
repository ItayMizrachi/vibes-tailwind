    ...
    <>
       <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3">
          ...
          <Lightbox
            ...
            renderPrevButton={() => (< ArrowLeftIcon onClick={gotoPrevious} className="btn" />)}
            renderNextButton={() => (< ArrowRightIcon onClick={gotoNext}  className="btn" />)}
