  ...
  return (
    ...
    {userInfo.user_name  ? (
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3">
        ...
        <Link to="/">
          <button class="sm:w-full p-3 bg-blue-500 rounded-lg lg:w-auto my-2 border py-4 px-8 text-center text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50">
            Take me home!
          </button>
        </Link>
      </div>
